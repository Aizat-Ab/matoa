  ...
  return (
    <div className="hero">
      ...
      <div className="hero__left col-6">
        ...
        <Link to="/way" className="hero__discover" href="">
          Discover
        </Link>
