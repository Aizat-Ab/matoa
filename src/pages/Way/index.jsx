    ...
    return (
        <div className='way'>
            ...
            {navWords.map((item, index)=>{
                return <li onClick={()=>navWord(index)} className={classNames({active: nav === index})}>{item}</li>
            })}
            </ul>
            <div className='way__hero'>
                ...
                <div className='way__right'>
                    <div className='way__title'>WAY KAMBAS
                    MINI EBONY</div>
                    <p className='way__old-price'>Rp 1.280.000</p>
                    <p className='way__new-price'>Rp 1.024.000</p>
