    ...
    return (
        <div className='way'>
            ...
            {navWords.map((item, index)=>{
                return <Link to={item.link} onClick={()=> (index)} className={classNames({active: nav === index})}>{item.title}</Link>
            })}
            </ul>
            <div className='way__hero'>
                ...
                <div className='way__right'>
                    ...
                    <div className='way__btn row'>
                        ...
                        <button className='hero__btn'><svg width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
